                                            ...
                                            {hemeBoxData.length > 0 &&
                                                hemeBoxData?.map((value, index) => {
                                                    return (
                                                        <div
                                                            key={index}
                                                            className={`box__subtitle ${value.border && "my_border"
                    ...
                    <div className="row ">
                        <div className="col-12 col-md-7 px-5">
                            <div className="services__text">
                                ...
                                <Fade direction="up" duration={1000}>
                                    <p style={{ width: "650px" }} className="services__subtitle pe-5 text-start">
                                        On the other hand, we denounce with righteous indignation
                                        and dislike men who are so beguiled and demoralized by the
                                        charms of pleasure of the moment, so blinded by desire, that
                                        they cannot foresee the pain and trouble that are bound to
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <div>
                                                            ...
                                                            <p style={{ width: "350px" }} className="mb-0 services__box__subtitle mt-3 ">
                                                                {value.subtitle}
                                                            </p>
                                                        </div>
                                                    </Fade>
                                    ...
                                    swiperData.map((value, index) => {
                                        return (
                                            <SwiperSlide key={index}>
                                                <div data-aos-duration={value.duration}
                                                    data-aos="fade-up"
                                                    className="w-100"
                                                >
                                                    <div style={{ overflow: 'hidden', borderRadius: '10px' }} className="w-100">
                                                        <img className="swiper__photo" src={value.img} alt={value.title} />
                                                    </div>
                ...
                <div className="contact__section position-relative padding__my mb-5">
                    ...
                    <div className="row">
                        ...
                        >
                            ...
                            <MyButton width={"322.13px"} height={"41.66px"} className="mt-4">
                                Log in
                            </MyButton>
